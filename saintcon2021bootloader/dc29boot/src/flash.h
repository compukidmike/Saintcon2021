...
//If the flash was memory mapped, this is where it would be
//We're not doing that, but this is useful for UF2 programming to differentiate the flash data
#define FLASH_MEMORY_OFFSET 0x4000000 
#define FLASH_MEMORY_SIZE	0x0800000 //64Mb (8MB)
